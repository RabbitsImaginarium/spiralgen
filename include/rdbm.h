...
#define RDB_CERD_CONSTANT_FILTER       0x1000   /* 4096 */ /* MRIge61411  */
...
typedef struct _RDB_HEADER_REC
{
   ...
   short    rdb_hdr_frame_size;        /* rhfrsize  xres 		0 - 1024 */
   ...
   short    rdb_hdr_da_xres;           /* rhdaxres 			0 - 1024 */
   ...
   long     rdb_hdr_raw_pass_size;     /* rhrawsize 			0 - 2147483647*/
   long     rdb_hdr_sspsave;           /* rhsspsave 			0 - 2147483647*/
   long     rdb_hdr_udasave;           /* rhudasave 			0 - 2147483647*/
   ...
   short    rdb_hdr_ileaves;           /* Nunmber of interleaves */
   ...
   short    rdb_hdr_excess [400]; /* free space for later expansion */
...
/*---------------------------------------------------------------------
 ...
 ---------------------------------------------------------------------*/
	...
	/*
	 * This section of typedef's depending on the structures
	 * defined in toolsdata.h and imagedb.h
	 *
	 * If the size of any following structure changes in the
	 * above include file, this file must be updated accordingly.
	 */
...
#define IMAGEDB_H_INCL
	...
	typedef char SERIESDATATYPE[1028];
	typedef char MRIMAGEDATATYPE[1044];
#endif
...
typedef struct
{
	...
	RDB_DATA_ACQ_TAB       rdb_hdr_data_acq_tab; /* 20480 bytes */
	...
	SERIESDATATYPE         rdb_hdr_series;       /*  1028 imagedb.h */
	MRIMAGEDATATYPE        rdb_hdr_image;        /*  1044 imagedb.h */
}       POOL_HEADER;                                 /* 39984 total */
